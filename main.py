...
class InstaFollower:
    ...
    def find_followers(self):
        ...
        time.sleep(8.2)
        # The XPATH of the modal will change over time. Update accordingly
        modal_xpath = "/html/body/div[6]/div[1]/div/div[2]/div/div/div/div/div[2]/div/div/div[2]"
        modal = self.driver.find_element(By.XPATH, value=modal_xpath)
        for i in range(5):
            # In this case I'm executing some Javascript, that's what the execute_script() does.
            # The method can accept the script as well as an HTML element.
            # The modal in this case, becomes the argument[0] in the script.
            # Then I'm using Javascript to say: "scroll the top of the modal (popup) element by the height of the modal."
